      ...
      <section className='text-gray-600 body-font'>
        <div className='container mx-auto flex flex-col px-5 py-24 justify-center items-center'>
          <div className='w-full md:w-2/3 flex flex-col mb-16 items-center text-center'>
            ...
            <p className='text-lg mt-2 text-gray-500 mb-1 w-full'>
        ...
        <div className='container px-5 py-0 mx-auto'>
          <div className='xl:w-1/2 lg:w-3/4 w-full mx-auto text-center'>
            ...
            <p className='leading-relaxed text-lg'>
              CKG means Chitwan Kagaz Ghar. The wholeseller of weeding cards &
              printing materials.CKG means Chitwan Kagaz Ghar. The wholeseller
              of weeding cards & printing materials.CKG means Chitwan Kagaz
              Ghar. The wholeseller of weeding cards & printing materials.CKG
              means Chitwan Kagaz Ghar. The wholeseller of weeding cards &
              printing materials.
            </p>
